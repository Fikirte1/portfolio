...
const projects = [
  ...
  },
  {
    ...
    description: 'Survey System Frontend built with laravel',
    image: 'Screenshot (959).png',
    tags: ['React', 'Express', 'Stripe', 'Frontend'],
  ...
  },
  {
    id: 3,
    title: 'Survey System',
    description: 'A survey System Backend built with laravel.',
  ...
  },
  {
    ...
    demo: 'https://figma.com/your-figma-link',
  },
   {
    id: 4,
    title: 'website deign',
...
const categories = ['All', 'React', 'Node.js', 'Full Stack', 'Frontend', 'Backend', 'Figma', 'Design'];
